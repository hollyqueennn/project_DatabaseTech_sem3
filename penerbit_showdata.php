...
<body>
  ...
  <div class="container">
    ...
    <table class="table table-hover text-center">
      ...
      <tbody>
        <?php
        $sql = "SELECT * FROM `buku` NATURAL JOIN `penerbit` WHERE id_penerbit = id_penerbit AND nama_penerbit = '$penerbit'";
